...
# TRAINING DATA tr --------------------------------------------------------------------------------
tr=pd.read_csv("TestingRegion1.csv")
#tr=pd.read_csv("TestingRegion1.csv")
#tr=pd.read_csv("TestingRegion1.csv")
...
def DecisionTree():
    ...
    if (h=='yes'):
        t1.delete("1.0", END)
        t1.insert(END, disease[a] + ' at '+ region )
    else:
        t1.delete("1.0", END)
...
def randomforest():
    ...
    if (h=='yes'):
        t2.delete("1.0", END)
        t2.insert(END, disease[a] + ' at '+ region )
    else:
        t2.delete("1.0", END)
...
def NaiveBayes():
    ...
    if (h=='yes'):
        t3.delete("1.0", END)
        t3.insert(END, disease[a] + ' at '+ region )
    else:
        t3.delete("1.0", END)
...
def NeuralNetwork():
    ...
    if (h=='yes'):
        t4.delete("1.0", END)
        t4.insert(END, disease[a] + ' at '+ region )
    else:
        t4.delete("1.0", END)
...
#w2 = Label(root, justify=LEFT, text="Project by", fg="white", bg="blue")
...
S6Lb = Label(root, text="SELECT Region", fg="yellow", bg="black")
...
nnLb = Label(root, text="NeuralNetwork", fg="white", bg="red")
nnLb.grid(row=21, column=0, pady=10, sticky=W)
...
REGEN = OptionMenu(root, REGION,*OPTIONS2)
REGEN.grid(row=12, column=1)
...
nn = Button(root, text="NeuralNetwork", command=NeuralNetwork,bg="green",fg="yellow")
nn.grid(row=11, column=3,padx=10)
